...
class ConfigurationInitializer {
    ...
    @Nonnull
    static <T extends SecurityConfiguration> T initializeConfiguration(@Nonnull SecurityProvider securityProvider, @Nonnull T configuration, @Nonnull RootProvider rootProvider, @Nonnull TreeProvider treeProvider) {
        return initializeConfiguration(securityProvider, configuration, ConfigurationParameters.EMPTY, rootProvider, treeProvider);
    }

    @Nonnull
    static <T extends SecurityConfiguration> T initializeConfiguration(@Nonnull SecurityProvider securityProvider, @Nonnull T configuration, @Nonnull ConfigurationParameters parameters, @Nonnull RootProvider rootProvider, @Nonnull TreeProvider treeProvider) {
    ...
    static void initializeConfigurations(@Nonnull SecurityProvider securityProvider,
        ...
        for (SecurityConfiguration config : configs) {
            initializeConfiguration(securityProvider, config, parameters, rootProvider, treeProvider);
        }
    }
}