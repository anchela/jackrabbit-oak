...
public class SecurityProviderRegistration {
    ...
    private SecurityProvider createSecurityProvider(@Nonnull BundleContext context) {
        ...
        securityProvider.setAuthenticationConfiguration(ConfigurationInitializer.initializeConfiguration(securityProvider, authenticationConfiguration, rootProvider, treeProvider));
        securityProvider.setPrivilegeConfiguration(ConfigurationInitializer.initializeConfiguration(securityProvider, privilegeConfiguration, rootProvider, treeProvider));
        ...
        securityProvider.setUserConfiguration(ConfigurationInitializer.initializeConfiguration(securityProvider, userConfiguration, userParams, rootProvider, treeProvider));
        ...
        ConfigurationInitializer.initializeConfigurations(securityProvider, authorizationConfiguration, restrictionParams, rootProvider, treeProvider);
        securityProvider.setAuthorizationConfiguration(authorizationConfiguration);

        ConfigurationInitializer.initializeConfigurations(securityProvider, principalConfiguration, ConfigurationParameters.EMPTY, rootProvider, treeProvider);
        securityProvider.setPrincipalConfiguration(principalConfiguration);

        ConfigurationInitializer.initializeConfigurations(securityProvider, tokenConfiguration, ConfigurationParameters.EMPTY, rootProvider, treeProvider);
