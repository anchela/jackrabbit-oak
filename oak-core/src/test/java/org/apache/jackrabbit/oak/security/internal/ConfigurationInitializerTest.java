...
public class ConfigurationInitializerTest {
    ...
    public void testInitConfigurationReturnsSame() {
        ...
        assertSame(sc, ConfigurationInitializer.initializeConfiguration(sp, sc, rootProvider, treeProvider));
    }
    ...
    public void testInitConfigurationWithParamReturnsSame() {
        SecurityConfiguration sc = new SecurityConfiguration.Default();
        assertSame(sc, ConfigurationInitializer.initializeConfiguration(sp, sc, params, rootProvider, treeProvider));
    }
    ...
    public void testInitNonBaseConfiguration() {
        ...
        ConfigurationInitializer.initializeConfiguration(sp, sc, rootProvider, treeProvider);
    ...
    public void testInitBaseConfiguration() {
        ...
        SecurityConfiguration afterInit = ConfigurationInitializer.initializeConfiguration(sp, sc, rootProvider, treeProvider);
    ...
    public void testInitBaseConfigurationWithParam() {
        ...
        SecurityConfiguration afterInit = ConfigurationInitializer.initializeConfiguration(sp, sc, params, rootProvider, treeProvider);
        assertSame(sc, afterInit);
    ...
    public void testInitCompositeConfiguration() {
        ...
        ConfigurationInitializer.initializeConfigurations(sp, composite, params, rootProvider, treeProvider);
